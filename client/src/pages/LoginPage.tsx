...
export default function LoginPage() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    setError(null);
    try {
      // FIX: pass navigate so AuthContext uses React Router instead of
      // window.location.href, keeping the SPA history stack intact.
      await login({ email: email.trim(), password }, (path) =>
